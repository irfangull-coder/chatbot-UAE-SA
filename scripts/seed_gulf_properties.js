...
const SAMPLE_PROPERTIES = [
  ...
  // ─── SAUDI ARABIA: DAMMAM (BUY) ───
  {
    property_id: 'DMM-BUY-001',
    country: 'Saudi Arabia',
    city: 'Dammam',
    area_district: 'Al Faisaliyah',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 3850000,
    currency: 'SAR',
    price_display: 'SAR 3,850,000',
    bedrooms: 4,
    bathrooms: 4,
    area_sqft: 4500,
    area_sqm: 418,
    furnished: 'unfurnished',
    title: 'Modern 4-Bedroom Luxury Villa with Private Garden in Al Faisaliyah',
    description: 'Stunning luxury villa in prime Dammam. Features high ceilings, private landscaped garden, maid and driver quarters, dedicated majlis, and garage for 2 cars.',
    main_image: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&q=80',
    source_url: 'https://sa.propertyfinder.com',
    portal_name: 'PropertyFinder KSA',
    agent_name: 'Khaled Al-Dawsari',
    agent_phone: '+966 53 111 4455',
    broker_name: 'Eastern Province Realty'
  },
  {
    property_id: 'DMM-BUY-002',
    country: 'Saudi Arabia',
    city: 'Dammam',
    area_district: 'Al Shatea Gharbi',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 4400000,
    currency: 'SAR',
    price_display: 'SAR 4,400,000',
    bedrooms: 5,
    bathrooms: 5,
    area_sqft: 5100,
    area_sqm: 474,
    furnished: 'semi-furnished',
    title: 'Brand New Contemporary 5-Bed Villa Near Dammam Corniche',
    description: 'Exceptional modern design located in Al Shatea near the sea. Offers private swimming pool, garden terrace, elevator, and smart home automation.',
    main_image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80',
    source_url: 'https://sa.aqar.fm',
    portal_name: 'Aqar',
    agent_name: 'Fahad Al-Qahtani',
    agent_phone: '+966 50 777 8899',
    broker_name: 'Gulf Coast Properties'
  },
  {
    property_id: 'DMM-BUY-003',
    country: 'Saudi Arabia',
    city: 'Dammam',
    area_district: 'Al Fursan',
    listing_type: 'buy',
    property_type: 'Townhouse',
    price: 1250000,
    currency: 'SAR',
    ...
    area_sqm: 232,
    furnished: 'unfurnished',
    title: 'Elegant 3-Bedroom Family Townhouse in Al Fursan, Dammam',
    description: 'Quiet family-friendly gated community with 24/7 security, community parks, and close access to Riyadh-Dammam Highway.',
    main_image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80',
    source_url: 'https://sa.bayut.com',
    portal_name: 'Bayut KSA',
    agent_name: 'Ziyad Al-Malki',
    agent_phone: '+966 56 444 3322',
    broker_name: 'Horizon Real Estate'
  },
  {
    property_id: 'DMM-BUY-004',
    country: 'Saudi Arabia',
    city: 'Dammam',
    area_district: 'Al Mazruiyah',
    listing_type: 'buy',
    property_type: 'Apartment',
    price: 820000,
    currency: 'SAR',
    price_display: 'SAR 820,000',
    bedrooms: 3,
    bathrooms: 2,
    area_sqft: 1750,
    area_sqm: 162,
    furnished: 'semi-furnished',
    title: 'Spacious 3-Bedroom Apartment near Marina Mall, Dammam',
    description: 'Central location near Corniche and shopping centers. Modern kitchen, underground parking, and low maintenance fees.',
    main_image: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80',
    source_url: 'https://sa.propertyfinder.com',
    portal_name: 'PropertyFinder KSA',
    agent_name: 'Sara Al-Otaibi',
    agent_phone: '+966 55 999 1122',
    broker_name: 'Eastern Horizon Estates'
  },

  // ─── SAUDI ARABIA: AL KHOBAR (BUY) ───
  {
    property_id: 'KHB-BUY-001',
    country: 'Saudi Arabia',
    city: 'Al Khobar',
    area_district: 'Al Danah',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 4600000,
    currency: 'SAR',
    price_display: 'SAR 4,600,000',
    bedrooms: 5,
    bathrooms: 5,
    area_sqft: 5200,
    area_sqm: 483,
    furnished: 'semi-furnished',
    title: 'Grand 5-Bedroom Luxury Villa in Al Danah, Al Khobar',
    description: 'Prestigious residential district minutes from Causeway and beach. Features private pool, landscaped courtyard, rooftop terrace, and marble bathrooms.',
    main_image: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&q=80',
    source_url: 'https://sa.aqar.fm',
    portal_name: 'Aqar',
    agent_name: 'Ibrahim Al-Binali',
    agent_phone: '+966 50 222 3344',
    broker_name: 'Khobar Prime Properties'
  },
  {
    property_id: 'KHB-BUY-002',
    country: 'Saudi Arabia',
    city: 'Al Khobar',
    area_district: 'Al Rakah Al Janubiyah',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 3600000,
    currency: 'SAR',
    price_display: 'SAR 3,600,000',
    bedrooms: 4,
    bathrooms: 4,
    area_sqft: 4300,
    area_sqm: 400,
    furnished: 'unfurnished',
    title: 'Modern 4-Bedroom Villa in Al Rakah near KFUPM',
    description: 'Superb location between Dammam and Khobar. Large reception majlis, driver room, private garden, and modern kitchen cabinetry.',
    main_image: 'https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?w=800&q=80',
    source_url: 'https://sa.propertyfinder.com',
    portal_name: 'PropertyFinder KSA',
    agent_name: 'Mona Al-Shehri',
    agent_phone: '+966 54 333 7788',
    broker_name: 'Arabian Gulf Homes'
  },

  // ─── UAE: SHARJAH (BUY) ───
  {
    property_id: 'SHJ-BUY-001',
    country: 'UAE',
    city: 'Sharjah',
    area_district: 'Al Zahia',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 3200000,
    currency: 'AED',
    price_display: 'AED 3,200,000',
    bedrooms: 4,
    bathrooms: 4,
    area_sqft: 3800,
    area_sqm: 353,
    furnished: 'unfurnished',
    title: 'Luxury 4-Bedroom Villa in Al Zahia Gated Community',
    description: 'Sharjah’s premier lifestyle destination. Direct park access, private garden, club house amenities, and 5 minutes to City Centre Al Zahia.',
    main_image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=80',
    source_url: 'https://www.bayut.com',
    portal_name: 'Bayut',
    agent_name: 'Jamal Al-Suwaidi',
    agent_phone: '+971 50 888 1234',
    broker_name: 'Sharjah Oasis Realty'
  },
  {
    property_id: 'SHJ-BUY-002',
    country: 'UAE',
    city: 'Sharjah',
    area_district: 'Masaar (Sendian)',
    listing_type: 'buy',
    property_type: 'Townhouse',
    price: 1850000,
    currency: 'AED',
    ...
    area_sqm: 241,
    furnished: 'unfurnished',
    title: 'Forest Community 3-Bed Townhouse in Masaar, Sharjah',
    description: 'Live surrounded by 50,000 trees, continuous forested green spine, cycling tracks, international schools, and sports plaza.',
    main_image: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&q=80',
    source_url: 'https://www.propertyfinder.ae',
    portal_name: 'PropertyFinder',
    agent_name: 'Noura Al-Mazrouei',
    agent_phone: '+971 52 444 5566',
    broker_name: 'Arada Direct Realty'
  },

  // ─── UAE: AJMAN (BUY) ───
  {
    property_id: 'AJM-BUY-001',
    country: 'UAE',
    city: 'Ajman',
    area_district: 'Al Yasmeen',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 1450000,
    currency: 'AED',
    price_display: 'AED 1,450,000',
    bedrooms: 4,
    bathrooms: 4,
    area_sqft: 3400,
    area_sqm: 316,
    furnished: 'unfurnished',
    title: 'Spacious 4-Bedroom Independent Villa in Al Yasmeen, Ajman',
    description: '100% freehold for all nationalities. Large majlis, modern stone facade, private parking, and direct access to Sheikh Mohammed Bin Zayed Road.',
    main_image: 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=800&q=80',
    source_url: 'https://www.bayut.com',
    portal_name: 'Bayut',
    agent_name: 'Majid Al-Nuaimi',
    agent_phone: '+971 56 123 4567',
    broker_name: 'Emirates Choice Properties'
  },

  // ─── UAE: RAS AL KHAIMAH (BUY) ───
  {
    property_id: 'RAK-BUY-001',
    country: 'UAE',
    city: 'Ras Al Khaimah',
    area_district: 'Mina Al Arab',
    listing_type: 'buy',
    property_type: 'Villa',
    price: 3650000,
    currency: 'AED',
    price_display: 'AED 3,650,000',
    bedrooms: 4,
    bathrooms: 5,
    area_sqft: 4200,
    area_sqm: 390,
    furnished: 'semi-furnished',
    title: 'Beachfront 4-Bedroom Luxury Villa in Mina Al Arab, RAK',
    description: 'Island living with direct private beach access, landscaped garden, lagoon views, community clubhouse, and 5-star resort amenities.',
    main_image: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&q=80',
    source_url: 'https://www.propertyfinder.ae',
    portal_name: 'PropertyFinder',
    agent_name: 'Hamad Al-Zaabi',
    agent_phone: '+971 50 678 9012',
    broker_name: 'RAK Island Living'
  }
];
